...
export default function PelanggaranTerbaru() {
  return (
    <>
      <div
        className={`md:mx-4 md:p-4   gap-4  ${dataAnakHandler(
          2,
          "hidden",
          "grid"
        )}`}
      >
        ...
        {AktivitasSementara.map(function (aktivitas) {
          return (
            <div className="flex items-center justify-start  md:py-2 py-4   border border-red-600 rounded-2xl px-4">
...
export function PelanggaranAnakBanyak() {
  return (
    <>
      <div className="mt-4 mb-6 md:p-2 p-4 gap-2 grid  rounded-2xl  bg-white">
        <h1 className="text-xl text-green-700 font-semibold mb-3">
          Pelanggaran Terbaru
        </h1>
        {AktivitasSementara.map(function (aktivitas) {
