...
const EditPelanggaran = () => {
  ...
  useEffect(() => {
    ...
    const getDataById = async () => {
      ...
      musyrif_id,
      status,
      data_pelanggaran: data_pelanggaran_id (
        kategori,
        poin,
        jenis:jenis_pelanggaran_id (nama)
      )`
        )
        .eq("id", id)
        .single();
      ...
      if (data) {
        setValue(data.santri_id);
        setSelectedPelanggaranId(data.data_pelanggaran_id);
        setJenisPelanggaran(data.data_pelanggaran?.jenis?.nama || "");
        setPoin(data.data_pelanggaran?.poin || "");
        setKategori(data.data_pelanggaran?.kategori || "");
